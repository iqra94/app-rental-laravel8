                                                ...
                                                <div class="row align-items-center">
                                                    <div class="card card-highlighted">
                                                        <form action="{{ route('booking.store') }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <input type="date" class="form-control mt-2" placeholder="Tanggal Pesan" id="tgl_pesan" name="tgl_pesan" required>
    
                                                            <input type="date" class="form-control mt-3" placeholder="Tanggal Dikembalikan" id="tgl_kembali" name="tgl_kembali" required>
