                ...
                <div id="auth-left">
                    ...
                    @if ($errors->any())
                        <div class="alert alert-danger">
                            <ul>
                                <!-- @error('email')
                                    <li>Maaf field harus disi</li>
                                @enderror -->
                                @error('name')
                                    <li>Maaf data sudah digunakan / harus disi</li>
                                @enderror
                            </ul>
                        </div>
                    @endif
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="number" class="form-control form-control-xl" placeholder="No SIM" name="no_sim">
                            <div class="form-control-icon">
                                <i class="bi bi-phone"></i>
                            </div>
                        </div>
